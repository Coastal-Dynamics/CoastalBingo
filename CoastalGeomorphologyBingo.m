...
numBingoCards = 10; % number of bingo cards to create
...
for ii = 1:numBingoCards
    ...
    %     axis off;
    title('COASTAL GEOMORPHOLOGY BINGO!','OSM2026 EDITION','FontSize',16,'FontName',fontName)
    ...
    pngName = ['BingoCard_' num2str(ii,'%04.f') ''];
